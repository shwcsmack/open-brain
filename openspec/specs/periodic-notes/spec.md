...
Periodic notes provide structured journaling and planning at multiple time granularities (daily, weekly, monthly, quarterly, yearly), with idempotent creation, user-defined templates, and a calendar navigator for easy access.
