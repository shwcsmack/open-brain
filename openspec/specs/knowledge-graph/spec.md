...
The knowledge graph provides a visual, interactive representation of how notes are connected via wiki-links, helping users discover relationships and navigate the note network spatially.
