...
Task management allows users to track to-dos both as standalone tasks and inline within notes via Markdown checkboxes, with status grouping, priority filtering, and two-way sync between the editor and the task database.
